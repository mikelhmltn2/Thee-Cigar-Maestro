  ...
  constructor(uiManager) {
    ...
    this.steps = [
      {
        ...
        content:
          'This is your main navigation. Use these sections to explore different aspects of cigar culture.',
        position: 'bottom',
        action: 'highlight',
      },
      {
        ...
        content:
          'Start here to discover cigars in our interactive 3D visualization. Click on any cigar to learn more!',
        position: 'bottom',
        action: 'click',
      },
      {
        ...
        content:
          'Use these filters to narrow down cigars by wrapper type. Try unchecking and checking different options.',
        position: 'right',
        action: 'highlight',
      },
      {
      ...
      },
      {
        ...
        content:
          'Manage your cigar collection with smart tracking, aging insights, and environmental monitoring.',
        position: 'bottom',
        action: 'highlight',
      },
      {
      ...
      },
      {
        ...
        content:
          'This is where the magic happens! Explore cigars in 3D space. Use your mouse to rotate, zoom, and navigate.',
        position: 'center',
        action: 'highlight',
      },
    ];
    ...
    this.mobileSteps = [
      ...
      },
      {
        ...
        content:
          'Use touch gestures to explore: pinch to zoom, drag to rotate, tap to select cigars.',
        position: 'center',
        action: 'highlight',
      },
    ];
