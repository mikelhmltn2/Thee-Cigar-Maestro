...
const LuxuryButton = React.forwardRef<HTMLButtonElement, LuxuryButtonProps>(
  (
    ...
    const variants = {
      primary:
        'bg-gradient-to-r from-luxury-gold to-luxury-gold-light text-background-primary shadow-gold hover:shadow-gold-lg',
      secondary:
        'border-2 border-luxury-gold text-luxury-gold hover:bg-luxury-gold hover:text-background-primary',
      ghost: 'text-text-accent hover:text-luxury-gold-light',
      premium:
        'bg-gradient-to-br from-luxury-gold via-luxury-gold-light to-luxury-gold text-background-primary shadow-luxury hover:shadow-luxury-lg',
    };
