        ...
        <div className="container-luxury">
          <div className="text-center mb-16">
            ...
            <p className="text-luxury-body max-w-3xl mx-auto">
              Experience cigars like never before with our interactive 3D explorer. 
              Discover flavor profiles, origins, and perfect pairings through immersive visualization.
            </p>
          </div>
