          ...
          {Object.entries(filterOptions).map(([category, options]) => (
            <div key={category}>
              ...
              <select
                ...
                onChange={(e) => handleFilterChange(category as keyof RecommendationFilters, e.target.value)}
                ...
                <div className="flex-1 space-y-4">
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-text-muted">{rec.brand} • {rec.origin}</p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-1">
                        {rec.flavorNotes.map((note, idx) => (
                          <span key={idx} className="text-xs bg-background-accent text-text-secondary px-2 py-1 rounded-luxury">
                            {note}
                          </span>
                        ))}
                      </div>
