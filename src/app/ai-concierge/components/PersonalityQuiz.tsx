...
const PersonalityQuiz = () => {
  ...
  const questions: QuizQuestion[] = [
    {
      ...
      options: [
        ...
        {
          value: 'regular',
          label: 'Regular enthusiast',
          description: 'I smoke cigars regularly and know my preferences',
        },
        {
          value: 'expert',
          label: 'Connoisseur',
          description: "I'm very knowledgeable about cigars and terroir",
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          description: 'After dinner or work to unwind',
        },
        {
          value: 'special',
          label: 'Special occasions',
          description: 'Celebrations, achievements, or events',
        },
        {
          value: 'social',
          label: 'Social gatherings',
          description: 'With friends, at lounges, or parties',
        },
        {
          value: 'contemplative',
          label: 'Quiet reflection',
          description: 'Alone time for thinking or meditation',
        },
      ],
    },
    {
      ...
      options: [
        {
          value: 'mild',
          label: 'Mild & Creamy',
          description: 'Vanilla, cream, light coffee, nuts',
        },
        {
          value: 'balanced',
          label: 'Balanced & Complex',
          description: 'Mix of sweet and savory, herbs, citrus',
        },
        {
          value: 'rich',
          label: 'Rich & Earthy',
          description: 'Dark chocolate, leather, wood, tobacco',
        },
        {
          value: 'bold',
          label: 'Bold & Spicy',
          description: 'Pepper, espresso, dark spirits, strong cheese',
        },
      ],
    },
    {
      ...
      options: [
        ...
        { value: 'long', label: '1.5-2 hours', description: 'Extended, leisurely experience' },
        {
          ...
          description: 'I like having options for different times',
        },
      ],
    },
    {
      ...
      options: [
        {
          value: 'coffee',
          label: 'Coffee or Tea',
          description: 'Espresso, cappuccino, or premium tea',
        },
        {
          value: 'whiskey',
          label: 'Whiskey or Bourbon',
          description: 'Aged spirits with complex flavors',
        },
  ...
  const analyzeAnswers = (userAnswers: Record<number, string>): QuizResult => {
    ...
    let description =
      'You appreciate quality and are open to new experiences while respecting tradition.';
    ...
    if (experience === 'new' && flavor === 'mild') {
      ...
      description =
        "You're beginning your journey and prefer smooth, approachable cigars that welcome newcomers.";
      ...
      description =
        'You seek complexity and intensity, appreciating the finest nuances in premium tobacco.';
      ...
      description =
        'You view cigars as a meditative experience, appreciating craftsmanship and heritage.';
      ...
      description =
        'You enjoy cigars as a social experience, preferring versatile options that please everyone.';
  ...
  if (isCompleted && result) {
    return (
      ...
      >
        ...
        <p className='text-luxury-body mb-8 max-w-2xl mx-auto'>{result.description}</p>
        ...
        <div className='grid md:grid-cols-3 gap-6 mb-8'>
          ...
          <div className='card-glass p-4'>
            <h4 className='font-display text-luxury-gold font-semibold mb-2'>
              Recommended Origins
            </h4>
        ...
        <div className='flex flex-col sm:flex-row gap-4 justify-center'>
          ...
          <button className='btn-primary'>Get My Recommendations</button>
        </div>
      </motion.div>
    );
  }
