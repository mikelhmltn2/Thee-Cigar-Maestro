...
export const metadata: Metadata = {
  ...
  keywords: ['AI cigar recommendations', 'cigar sommelier', 'personalized cigars', 'cigar chatbot', 'luxury cigars'],
}
        ...
        <div className="container-luxury text-center relative z-10">
          ...
          <AnimatedReveal delay={0.3}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {[
                { icon: MessageSquare, title: 'Natural Conversations', desc: 'Chat naturally about your preferences' },
                { icon: Target, title: 'Precision Matching', desc: '99.9% recommendation accuracy' },
                { icon: Sparkles, title: 'Evolving Intelligence', desc: 'Learns and improves with every interaction' },
              ].map((feature, index) => (
          ...
          <AnimatedReveal>
            <div className="text-center mb-12">
              <h2 className="text-luxury-subheading mb-6">
                Discover Your <GoldGradientText variant="premium">Cigar Personality</GoldGradientText>
              </h2>
