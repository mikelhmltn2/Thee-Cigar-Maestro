      ...
      <div className='container-luxury'>
          ...
          <div className='grid lg:grid-cols-6 gap-12'>
            ...
            <div className='lg:col-span-2 space-y-6'>
              ...
              <p className='text-text-secondary leading-relaxed'>
                Experience the pinnacle of cigar culture with AI-driven recommendations, luxury
                curation, and immersive digital experiences for every enthusiast.
              </p>
            ...
            {Object.entries(footerLinks).map(([category, links]) => (
              <div key={category} className='space-y-4'>
                <h4 className='font-display text-lg font-semibold text-luxury-gold'>{category}</h4>
        ...
        <div className='py-4 bg-background-accent/30 rounded-luxury mt-6'>
          <p className='text-center text-sm text-text-muted'>
            <strong className='text-luxury-gold'>Age Verification Required:</strong> You must be 21+
            to purchase tobacco products. By using this site, you confirm you are of legal smoking
