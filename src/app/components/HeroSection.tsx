      ...
      >
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-luxury-gold/10 backdrop-blur-sm border border-luxury-gold/30 rounded-full">
            ...
            <span className="text-sm text-luxury-gold font-medium">Est. 2024 • Premium Collection</span>
          </div>
        </motion.div>
        ...
        >
          Discover the world's finest cigars through AI-powered curation, 
          immersive 3D experiences, and exclusive member benefits
        </motion.p>
