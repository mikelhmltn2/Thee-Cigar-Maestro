        ...
        >
          {!isSubscribed ? (
            <>
              ...
              >
                <div className='flex items-center justify-center space-x-2 mb-3'>
                  ...
                  <span className='font-display text-luxury-gold font-semibold'>Welcome Gift</span>
                </div>
                <p className='text-sm text-text-secondary'>
                  New subscribers receive a complimentary cigar cutter and 15% off their first
                  purchase.
                </p>
              </motion.div>
            </>
            ...
            >
              ...
              <p className='text-luxury-body max-w-2xl mx-auto mb-8'>
                You're now part of our exclusive community. Check your email for a special welcome
                gift and your first curated recommendations.
              </p>

              <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                <button onClick={() => setIsSubscribed(false)} className='btn-secondary'>
