      ...
      <div className='container-luxury'>
        ...
        >
          ...
          <motion.p variants={itemVariants} className='text-luxury-body max-w-2xl mx-auto'>
            Discover our hand-selected collection of the world's finest cigars, curated by experts
            and loved by connoisseurs.
          </motion.p>
        </motion.div>
            ...
            >
              <div className='card-luxury h-full overflow-hidden interactive-hover'>
                ...
                <div className='relative h-64 mb-6 rounded-luxury-lg overflow-hidden bg-gradient-to-br from-background-accent to-background-leather'>
                  ...
                  {/* Action buttons */}
                  <div
                    className={`absolute inset-0 bg-background-primary/80 flex items-center justify-center gap-4 transition-all duration-300 ${
                ...
                <div className='space-y-4'>
                  ...
                  {/* Description */}
                  <p className='text-text-secondary text-sm leading-relaxed'>{cigar.description}</p>
                  ...
                  <div className='flex items-center justify-between pt-4 border-t border-text-muted/20'>
                    <div className='flex items-center space-x-2'>
                      ...
                      <span className='text-2xl font-bold text-luxury-gold'>${cigar.price}</span>
                    </div>
                    <Link href={`/cigars/${cigar.id}`} className='btn-primary text-sm px-6 py-2'>
                      View Details
                    </Link>
                  </div>
                </div>
