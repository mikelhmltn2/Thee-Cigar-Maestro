  ...
  const features = [
    {
      ...
      description:
        'Discover your perfect cigar with our advanced AI that learns your preferences, considers your mood, and suggests the ideal smoke for any occasion.',
      link: '/ai-concierge',
      highlights: [
    ...
    },
    {
      ...
      description:
        'Manage your cigar collection digitally with aging reminders, optimal storage conditions, and smart inventory tracking.',
      link: '/humidor',
      highlights: [
    ...
    },
    {
      ...
      title: 'AI Concierge',
      description:
        '24/7 expert guidance from our AI sommelier for pairing advice, cigar education, and personalized recommendations.',
      link: '/ai-concierge',
      highlights: [
        '24/7 availability',
      ...
      <div className='container-luxury relative z-10'>
        ...
        >
          ...
          <motion.p variants={itemVariants} className='text-luxury-body max-w-3xl mx-auto'>
            Our cutting-edge AI transforms how you discover, collect, and enjoy cigars. From
            personalized recommendations to intelligent collection management, experience the future
            of cigar culture.
          </motion.p>
        </motion.div>
                ...
                <Link href={feature.link}>
                  <div className='card-luxury h-full interactive-hover group-hover:shadow-gold transition-all duration-500'>
                    ...
                    <div className='relative mb-6'>
                      <div
                        className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-luxury-lg flex items-center justify-center shadow-luxury group-hover:shadow-gold-lg transition-all duration-500`}
                      >
        ...
        >
          <div className='card-glass p-8 max-w-2xl mx-auto'>
            ...
            <p className='text-text-secondary mb-6'>
              Join thousands of cigar enthusiasts who trust our AI to enhance their smoking
              experience.
            </p>
